           ...
           <div class="formcontainer">
            <form action="{{route('storecourse')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-outline mb-1">
                  ...
                  <input type="text" name="link" id="form4Example2" class="form-control" placeholder="www.example.com/course" />
                </div>
                <div class="form-outline mb-1">
                ...
                <div class="form-outline mb-1">
                  ...
                  <textarea name="description" class="form-control" placeholder="Description example ,you can add up to 500 word here" id="form4Example3" rows="12"></textarea>
                </div>
