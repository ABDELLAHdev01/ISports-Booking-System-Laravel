            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="d-flex justify-content-end">
                        <a href="{{route('addcourse')}}" class="btn btn-outline-success"><i class="bi bi-pencil-square"></i> Add Course</a>
                    </div>
                </div>
          </div>
            </div>
                ...
                <td>
                  ...
                  <div class="d-flex">
                    ...
                    <form action="{{route('editcourse')}}" method="post">
                        ...
                        <button type="submit" class="btn btn-outline-success btn-sm me-2"><i class="bi bi-pencil-square"></i> Edit</button>
                    </form>
                    <div>
                    {{-- delete btn --}}
