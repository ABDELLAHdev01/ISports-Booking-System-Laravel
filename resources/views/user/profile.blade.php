                    ...
                    <div class="col-md-12 border-right">
                        <div class="p-3 py-5">
                            ...
                            <form method="post" action="{{ route('profile.update') }}"  enctype="multipart/form-data">
                              ...
                              @method('patch')
                            <div class="row mt-2">
                                <div class="col-md-12 mb-1"><label class="labels">Full name</label><input type="text" name="name" class="form-control" placeholder="enter phone number" value="{{$user->name}}" ></div>
                            </div>
                            <div class="row mt-2">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12 mb-1"><label class="labels">Mobile Number</label><input  name="phone" type="text" class="form-control" placeholder="enter phone number"  value="{{$user->phone}}"></div>
                              </div>
                              <div class="row mt-3">

                                <div class="col-md-12"><label class="labels">Address Line </label><input type="text"  name="adress" class="form-control" placeholder="enter address line 1" value="{{$user->adress}}"></div>
                            </div>
