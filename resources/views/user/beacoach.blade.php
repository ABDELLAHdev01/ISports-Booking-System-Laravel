        ...
        <div class="container ">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 " >
                    ...
                    <p class="text-dark">Being a coach in sports is a fulfilling and rewarding profession that involves working with athletes to help them achieve their full potential. As a coach, you play a critical role in the development of your athletes, both on and off the field. </p>
                    <button data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-success w-75  mt-3 shadow rounded-3" >Apply now !</button>
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel"><i class="bi bi-clipboard-fill"></i> Apply for coach !</h1>
