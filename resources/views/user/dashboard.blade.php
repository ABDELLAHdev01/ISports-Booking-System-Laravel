               ...
               <div class="col">
                <div class="card h-100">
                  ...
                  <div class="card-footer d-flex">
                    ...
                    <a href="/dashboard/coach/{{$item->id}}" class="btn btn-success btn-sm ms-auto"><i class="bi bi-calendar2-check"></i> Book Now</a>
  ...
  <div class="card">
    ...
    <div class="card-footer d-flex">
      ...
      <small class="text-muted"><i class="bi bi-pencil-square "></i>  {{$item->author}}  </small>
        <a href="{{route('viewCourse',$item->id)}}" class="btn btn-success btn-sm ms-auto"><i class="bi bi-play-circle"></i> View Course</a>
