    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        <div class="card mb-3" style="max-width: 540px;">
            <div class="row g-0">
              <div class="col-md-4">
                <img 
                  src="https://yt3.googleusercontent.com/ytc/AL5GRJUVHpAonTI8wzoVx_j6pWAEUwtVwm9Go83MSgDGTA=s900-c-k-c0x00ffffff-no-rj"
                  alt="Trendy Pants and Shoes"
                  class="img-fluid rounded ml-4 py-3"
                />
              </div>
              <div class="col-md-8">
                <div class="card-body">
                  <h5 class="card-title">Au DD</h5>
                  <p class="card-text">
                    <div>
                        <figure class="" style="box-shadow: 3px">
                            <figcaption></figcaption>
                            <audio
                                controls
                                src="/PNL - Au DD [Clip Officiel](MP3_160K).mp3">
