...
<div class="row mb-4">
  ...
  text: ' No Articles Found!',
    ...
    <a href="/dashboard/articles/{{$article->id}}" style="  text-decoration: none;  color:black;  ">
    <div class="col">
      <div class="card h-100">
        <img src="{{$article->image}}" class="card-img-top" alt="Skyscrapers"/>
        <div class="card-body">
        ...
        <div class="card-footer">
          <small class="text-muted"><i class="bi bi-calendar-event"></i> {{$article->created_at}}</small>
        </div>
      </div>
    </div>
  </a>
