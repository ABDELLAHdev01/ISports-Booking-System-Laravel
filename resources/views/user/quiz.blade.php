...
<!-- /#wrapper -->
<script>const quizForm = document.getElementById('quiz-form');
    ...
    submitButton.addEventListener('click', function(e) {
      ...
      let trainingPlan = '';
      if (bmi < 18.5) {
        trainingPlan = 'You should focus on building muscle mass and gaining weight through strength training and a high-protein diet.';
      } else if (bmi < 25) {
        trainingPlan = 'You should focus on maintaining your current weight and building overall fitness through a combination of cardio and strength training.';
      } else if (bmi < 30) {
        trainingPlan = 'You should focus on losing body fat through a combination of cardio and strength training, and following a balanced, low-calorie diet.';
      } else {
        trainingPlan = 'You should focus on losing weight and reducing body fat through a combination of cardio and strength training, and following a balanced, low-calorie diet.';
      }
